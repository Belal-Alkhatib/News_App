...
import com.b.alkhatib.mvvmnewsapp.Article
...
interface ArticalDao {
    ...
    suspend fun upsert(article: Article):Long       // which stands for update or insert so it will insert a new article and if it is already in the database it will update it inserted and replace it. Long: which is the id that was insered
